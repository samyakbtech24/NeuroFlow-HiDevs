...
async def seed_db() -> None:
    ...
    async with pool.acquire() as conn:
        ...
        await conn.execute("INSERT INTO pipelines (id, name, config) VALUES ('00000000-0000-0000-0000-000000000000', 'mock-finetune', '{}') ON CONFLICT DO NOTHING")  # noqa: E501
        
        for i in range(10):
            run_id = uuid.uuid4()
            # 1. Insert fake pipeline_run
            await conn.execute(
                "INSERT INTO pipeline_runs (id, pipeline_id, query) VALUES ($1, '00000000-0000-0000-0000-000000000000', 'test query')",  # noqa: E501
                run_id
            )
