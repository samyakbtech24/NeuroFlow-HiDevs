...
class AnthropicProvider(BaseLLMProvider):
    def __init__(self, model_name: str = "claude-3-5-sonnet", api_key: str = "mock"):
    ...
    async def _execute_with_retry(self, func, *args, **kwargs):
        ...
        for attempt in range(4):
            try:
                ...
                logger.warning(f"Anthropic rate limit hit. Retrying in {retry_after} seconds... (Attempt {attempt + 1}/3)")
